...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var placeholder = 'placeholder="' + ((settings.oLanguage.sSearchPlaceholder != '') ? settings.oLanguage.sSearchPlaceholder : '') + '"';
		var input = '<input type="search" class="'+classes.sFilterInput+'" '+placeholder+'/>';
