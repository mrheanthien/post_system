...
// 1) Replace the options of target_id with data from values_arr 
// 2) Set the first option to "title" with value="title_value"
// Remember to re-init the dropkick();
function initDropkick(target_id, values_arr, title, title_value) {
	//Default params
	title = typeof title !== 'undefined' ? title : null;
    title_value = typeof title_value !== 'undefined' ? title_value : null;
	...
	$(container).remove();
	//Insert first value
	if(title != null && title_value != null)
		$(target_id).append("<option value="+title_value+">" + title + "</option>");
	//Insert the rest
	for(i in values_arr) {
		$(target_id).append("<option value=" + values_arr[i].value + ">" + values_arr[i].name + "</option>");
	}
}
